/**
 * Hierarchical Knowledge Extraction Prompt Prompt
 * 
 ...
 * 
 * Converted from: hierarchical-knowledge-extraction-prompt.md
 */

export const HIERARCHICAL_KNOWLEDGE_EXTRACTION_PROMPT = `# Hierarchical Knowledge Structure Extraction - Production Prompt
