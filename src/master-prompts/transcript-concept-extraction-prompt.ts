/**
 * Transcript Concept Extraction Prompt Prompt
 * 
 ...
 * 
 * Converted from: transcript-concept-extraction-prompt.md
 */

export const TRANSCRIPT_CONCEPT_EXTRACTION_PROMPT = `# Transcript Concept Extraction - Production Prompt
