/**
 * Syllabus Concept Extraction Prompt Prompt
 * 
 ...
 * 
 * Converted from: syllabus-concept-extraction-prompt.md
 */

export const SYLLABUS_CONCEPT_EXTRACTION_PROMPT = `# Syllabus Concept Extraction - Production Prompt
